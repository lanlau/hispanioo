...
const hiddenDocTypes = listItem =>
  !['blog_tag','blog_category', 'blog_post', 'siteSettings',  'page', 'author'].includes(listItem.getId())
  ...
  S.list()
    ...
    .items([
      ...
      .child(
        ...
        .title('Blog')
        .items([
          S.listItem().title('By Categories').showIcon(false),
          S.divider(),
          S.listItem()
          ...
          S.listItem().title('By Tags').showIcon(false),
          S.divider(),
         //Tags
         S.listItem()
         ...
         .child(
           ...
           .child( tagId =>
             ...
             .initialValueTemplates([
              S.initialValueTemplateItem('post-tag', {tagId})
            ])             
         ...
         S.listItem().title('By Publication date').showIcon(false),
         S.divider(),
